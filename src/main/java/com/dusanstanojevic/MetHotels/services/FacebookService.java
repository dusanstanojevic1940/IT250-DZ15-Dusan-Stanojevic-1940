...
public class FacebookService {
	...
	private final String clientId = "806007039513888";
	private final String clientSecret = "a66479388f9477ad7ca8f8dbd2460f5b";
	public FacebookService(PageRenderLinkSource linkSource, ApplicationStateManager applicationStateManager) {
		super();
		this.linkSource = linkSource;
		this.applicationStateManager = applicationStateManager;
	}
	public void getUserAccessToken(String code, String token) throws IOException, OAuthSystemException, OAuthProblemException {
	...
	public void publishLink(String link) {
		FacebookClient facebookClient = new DefaultFacebookClient(getFacebookServiceInformation().getAccessToken());
		facebookClient.publish("me/feed", FacebookType.class, Parameter.with("link", link));
	}
}